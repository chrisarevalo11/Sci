...
export interface QVBaseStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "NATIVE"
      | "allocate"
...
export interface QVBaseStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): QVBaseStrategy;
  waitForDeployment(): Promise<this>;

  interface: QVBaseStrategyInterface;
